...
export const News: FC = memo(() => {
    ...
    return (
        <div className={style.container}>
            ...
            <input className={style.searchInput} type="text" placeholder={'Найти пост...'} onChange={changeHandler}
                ...
                >
                    {() => (
                        <Form className={style.addPostContainer}>
                            <Field classname={style.formTitle} type="text" name="title" placeholder={'Заголовок...'}
                                   autocomplete="off"/>
                            <ErrorMessage name="title" component="div"/>
                            <Field classname={style.formText} as='textarea' type="textarea" name="text"
            ...
            <div className={style.postContainer}>
                {isAdmin ? proposedPosts.map(p => <ProposeItem key={p.id} title={p.title} text={p.text} data={p.data}
                                                               id={p.id}/>) : null}
            </div>
